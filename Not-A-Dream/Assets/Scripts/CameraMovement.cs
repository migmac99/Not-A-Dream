...
public class CameraMovement : MonoBehaviour {
	...
	void FixedUpdate () {
		if ((Player.GetComponent<RunePowers> ().Rune_1_State == "Bubble_Active") || (Player.GetComponent<Animator> ().GetAnimatorTransitionInfo (0).IsName ("Bubble_Pop -> playerJump")) || (Player.GetComponent<Animator> ().GetAnimatorTransitionInfo (0).IsName ("Bubble -> Bubble_Pop"))) {
